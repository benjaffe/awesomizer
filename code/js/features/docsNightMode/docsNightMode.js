...
;(function() {
  ...
  var cssFiles = ['docsNightMode.css']; // if you have CSS (relative path from this directory)
  ...
  function unload() {
    ...
    var s = document.getElementById(shortName + 'Style');
    s.parentElement.removeChild(s);
    console.log('unloading CSS files');
  }
